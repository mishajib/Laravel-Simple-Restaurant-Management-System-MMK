...
<head>
    ...
    <style>
        ...
        .owl-carousel .owl-wrapper, .owl-carousel .owl-item:nth-child({{ ++$key }}) .item {
            background: url({{ storageLink($slider->image) }});
                            ...
                            <li class="item" id="{{ $item->category->slug }}">
                                ...
                                <a href="#">
                                    <img style="width: 300px; height: 250px;"
                                         src="{{ storageLink($item->image) }}" class="img-responsive"
                                         alt="Food">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email"
                                               class="form-control reserve-form empty iconified" required id="email"
                                               placeholder="  &#xf1d8;  e-mail">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control reserve-form empty iconified"
                                               name="date_and_time" required id="datetimepicker1"
                                               placeholder="&#xf017;  Time">
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        {{ config('app.name') }} &copy; Copyright, {{ now()->year }} <a href="www.mi-shajib.com">MI
                            SHAJIB</a> &
