    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ route('home') }}">
                <img id="logo" src="{{ asset('assets/frontend/images/Logo_main.png') }}"
...
<section id="about" class="about">
    <img src="{{ asset('assets/frontend/images/icons/about_color.png') }}"
                    ...
                    <ul id="menu-pricing" class="menu-price">
                        @foreach($items as $item)
                            <li class="item" id="{{ $item->category->slug }}">
                                ...
                                <a href="#">
                                    <img style="width: 300px; height: 250px;" src="{{ asset('uploads/item/'.$item->image) }}" class="img-responsive"
                                         alt="Food">
...
<section id="reserve" class="reserve">
    <img class="img-responsive section-icon hidden-sm hidden-xs"
         src="{{ asset('assets/frontend/images/icons/reserve_black.png') }}">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row dis-table">
...
<section class="reservation">
    <img class="img-responsive section-icon hidden-sm hidden-xs"
         src="{{ asset('assets/frontend/images/icons/reserve_color.png') }}">
    <div class="wrapper">
        <div class="container-fluid">
            <div class=" section-content">
                <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email"
                                               class="form-control reserve-form empty iconified" required id="email" placeholder="  &#xf1d8;  e-mail">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control reserve-form empty iconified"
                                               name="dateandtime" required id="datetimepicker1"
                                               placeholder="&#xf017;  Time">
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        {{ config('app.name') }} &copy; Copyright, {{ now()->year }} <a href="www.mi-shajib.com">MI SHAJIB</a> &
                        Developed By <a href="www.mi-shajib.com">MISHAJIB</a>
                    </p>
                </div>
            </div>
        </div>
